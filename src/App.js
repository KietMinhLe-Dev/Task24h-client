    ...
    >
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-[330px_1fr] gap-8">
        ...
        <aside className="space-y-6">
          ...
          <div className={`p-6 border rounded-3xl transition-all duration-300 ${isDark
            ...
            <div className="space-y-4">
              ...
              {tasks.length === 0 && (
                <p className="text-xs text-zinc-500 text-center py-2 font-medium">Chưa có dữ liệu hôm nay</p>
              )}
            </div>
          </div>
        ...
        <section className="space-y-5">
          {/* TOP BAR */}
          <div
            className={`rounded-3xl p-5 border flex items-center justify-between ${isDark
                ? 'bg-zinc-900/60 border-zinc-900/80 shadow-2xl'
                : 'bg-white border-slate-200 shadow-md'
              }`}
          >
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`h-9 px-4 rounded-xl text-xs font-bold transition-all ${isDark
                    ? 'bg-zinc-950 border border-zinc-800 text-zinc-400 hover:text-white'
                    : 'bg-slate-100 text-slate-650 hover:bg-slate-200'
                  }`}
              >
                  ...
                  <div className="flex items-start justify-between gap-5 pl-2">
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0 space-y-1.5">
                        <h3
                          className={`text-base sm:text-lg font-bold leading-snug ${task.completed
                        ...
                        {task.description && (
                          <p className={`text-xs leading-relaxed max-w-xl ${task.completed ? 'opacity-40' : 'opacity-70'
                            }`}>
                            {task.description}
                          </p>
                        )}
                        ...
                        <div className="flex flex-wrap gap-2 pt-2.5">
                          ...
                          <div
                            className={`h-7 px-3.5 rounded-full text-[10px] font-extrabold flex items-center gap-1.5 border transition-all ${isDark
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      {!task.completed && (
                        <div className={`hidden sm:flex px-3.5 py-2 rounded-2xl border font-mono items-center gap-1.5 font-bold animate-pulse text-[11px] ${isDark
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/85 backdrop-blur-md transition-all duration-300 animate-fadeIn">
          <div className={`relative w-full max-w-4xl border rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.4)] overflow-hidden transition-all duration-300 ring-1 ${isDark
            ...
            {/* Modal Header */}
            <div className={`px-8 py-6 border-b flex items-center justify-between ${isDark ? 'border-zinc-900/50 bg-zinc-950/15' : 'border-slate-100 bg-slate-50/30'
              }`}>
              <div className="flex items-center gap-3">
            ...
            <form onSubmit={handleSubmit} className="divide-y divide-zinc-900/60">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 divide-y md:divide-y-0 md:divide-x divide-zinc-900/60">
                ...
                <div className="md:col-span-7 p-8 space-y-6">
                  <div className="space-y-2">
                    <label className="text-[11px] font-extrabold text-zinc-550 uppercase tracking-widest flex items-center gap-1.5">
                      Tiêu đề kế hoạch
                    </label>
                    <input
                      type="text"
                      ...
                      className={`w-full text-xl sm:text-2xl font-black bg-transparent border-0 outline-none focus:outline-none focus:ring-0 p-0 ${isDark ? 'text-white placeholder-zinc-800' : 'text-slate-805 placeholder-slate-350'
                        }`}
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className={`w-full text-sm sm:text-base bg-transparent border-none outline-none focus:outline-none focus:ring-0 p-0 resize-none h-44 ${isDark ? 'text-zinc-300 placeholder-zinc-800 font-medium leading-relaxed' : 'text-slate-700 placeholder-slate-405 leading-relaxed'
                        }`}
                    />
                  </div>
                </div>
                ...
                <div className={`md:col-span-5 p-8 space-y-7 ${isDark ? 'bg-zinc-950/20' : 'bg-slate-50/30'
                  }`}>
                      ...
                      {Object.entries(categories).map(([key, cat]) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4 py-2.5 rounded-xl border text-xs font-bold flex items-center gap-2 transition-all duration-200 hover:scale-[1.03] active:scale-95 ${isSelected
                                ? isDark
                      ...
                      {Object.entries(priorities).map(([key, pri]) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-4.5 py-2.5 rounded-xl border font-bold text-xs flex items-center gap-2 transition-all duration-200 hover:scale-[1.03] active:scale-95 ${isSelected
                                ? activeStyles[key]
                                : isDark
              ...
              <div className={`px-8 py-6 flex items-center justify-between ${isDark ? 'border-zinc-900/60 bg-zinc-950/10' : 'border-slate-100 bg-slate-50/15'
                }`}>
